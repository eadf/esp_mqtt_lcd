...
CFLAGS		= -Os -g -O2 -Wpointer-arith -Wundef -Werror -Wmissing-declarations  -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH
